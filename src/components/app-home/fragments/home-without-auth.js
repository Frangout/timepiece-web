...
class HomeWithoutAuth extends Component {
      ...
      <React.Fragment>
        ...
        <main>
          <Switch>
            ...
            <Route path={`${match.path}my-nfts`} component={SignIn} />
            <Route path={`${match.path}create`} component={SignIn} />
