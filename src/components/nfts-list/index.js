    ...
    if (!this.props.memes.success.data.length) {
      ...
      return (
        <React.Fragment>
          ...
          >
            {this.props.memes.success.data.map(meme => <Nft meme={meme} key={meme.memeId} />)}
          </Row>
          <Pagination
...
export default withRouter(connect(mapStateToProps, { })(NftsList));
