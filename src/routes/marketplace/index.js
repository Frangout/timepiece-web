      ...
      <React.Fragment>
        {
          this.state.currentTab === '1' ? (
            <header className="marketplace-info-wrapper">
              The most popular NFTs up for grabs!
            </header>
          ) : (
            <header className="marketplace-info-wrapper">
              New and shiny timepieces and dials...
            </header>
          )
        }
      </React.Fragment>
      ...
      <React.Fragment>
        ...
        <Tabs activeKey={this.state.currentTab} className="market-place-tabs">
          ...
          <Tabs.TabPane
            ...
            key="2"
          >
            <Route path={`${this.props.match.path}marketplace/all/:page?`} component={AllNfts} />
          </Tabs.TabPane>
        </Tabs>
        {/* <Switch>
        <Route path={`${this.props.match.path}/sale/:page?`} render={() => (
          ...
          <Tabs.TabPane tab="All Nfts" key="2">
          </Tabs.TabPane>
        </Tabs>
        )} />
