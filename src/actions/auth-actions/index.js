...
export const postUser = ({ sign, account, memer: sanNftr, avatar }) => async (dispatch) => {
  try {
    dispatch({
    ...
    const memer = sanNftr.trim().toLowerCase();
...
export const validateUserName = (memer = '') => async (dispatch) => {
  dispatch({
    type: USER_NAME_VALIDATE,
    payload: {
      memername: {
