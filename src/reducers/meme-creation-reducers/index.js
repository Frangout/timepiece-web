...
export default (state = INITIAL_STATE, { type, payload }) => {
  switch (type) {
    ...
    case CREATE_NFT_TRANSACTION_LOADING:
      return {
        ...state,
        meme: {
          ...state.meme,
    ...
    case CREATE_NFT_TRANSACTION_SUCCESS:
      return {
        ...state,
        meme: {
          ...state.meme,
    ...
    case CREATE_NFT_TRANSACTION_ERROR: 
    return {
      ...state,
      meme: {
        ...state.meme,
    ...
    case CREATE_NFT_TRANSACTION_HASH_LOADING:
      return {
        ...state,
        meme: {
          ...state.meme,
    ...
    case CREATE_NFT_TRANSACTION_HASH_ERROR:
      return {
        ...state,
        meme: {
          ...state.meme,
      ...
      case CREATE_NFT_TRANSACTION_HASH_SUCCESS:
      return {
        ...state,
        meme: {
          ...state.meme,
